...
class Line {
     ...
     * @param {[Point]} control points of the line
     */
    ...
    /*
     * Compute a certain number of points evenly distributed on the line
     *
     * This is the function to override in order to implement new type of lines
     *
     * @param {int} number of points
     * @return {[Point]} array of computed points
     */
    ...
    /*
     * Get the line generated by this line generator
     * @param {int} number of points
     * @return {[Point]} array of computed points
     */
